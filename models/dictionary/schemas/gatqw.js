 ...
 * @LastEditTime: 2021-04-22 11:20:56
 * @LastEditors: zpl
 */
...
export default () => {
  return {
    ...
    dmlb: { type: DataTypes.STRING(10), allowNull: false, defaultValue: 'GATQW', comment: '代码类别' },
    ...
    dmsm: { type: DataTypes.STRING(32), comment: '代码说明' }
  }
};
export const InfoSchema = S.object()
  ...
  .prop('mcsm', S.string().maxLength(32).description('代码说明'))
