...
const routerBaseInfo = {
  modelName_U: 'ServiceChannel',
  modelName_L: 'servicechannel',
  getURL: '/api/servicechannel/:id',
  getAllURL: '/api/servicechannels',
  getListURL: '/api/getServiceChannelList',
  putURL: '/api/servicechannel',
  deleteURL: '/api/servicechannels',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['servicechannel'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['servicechannel'], summary: '获取所有' } },
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['servicechannel'], summary: '根据条件获取列表' } },
      (request, reply) => method.queryList(request, reply),
  );

  const updateSchema = require('./update-schema');
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['servicechannel'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['servicechannel'], summary: '批量删除' } },
