...
const routerBaseInfo = {
  modelName_U: 'TmtTarget',
  modelName_L: 'tmttarget',
  getURL: '/api/tmttarget/:id',
  getAllURL: '/api/tmttargets',
  getListURL: '/api/getTmtTargetList',
  putURL: '/api/tmttarget',
  deleteURL: '/api/tmttargets',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['tmttarget'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['tmttarget'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['tmttarget'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['tmttarget'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['tmttarget'], summary: '批量删除' } },
      remove,
  );
