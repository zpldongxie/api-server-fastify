...
const routerBaseInfo = {
  modelName_U: 'ProjectTarget',
  modelName_L: 'projecttarget',
  getURL: '/api/projecttarget/:id',
  getAllURL: '/api/projecttargets',
  getListURL: '/api/getProjectTargetList',
  putURL: '/api/projecttarget',
  deleteURL: '/api/projecttargets',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['projecttarget'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['projecttarget'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['projecttarget'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['projecttarget'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['projecttarget'], summary: '批量删除' } },
      remove,
  );
