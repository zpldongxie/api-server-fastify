...
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['usergroup'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['usergroup'], summary: '获取所有' } },
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['usergroup'], summary: '根据条件获取列表' } },
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['usergroup'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['usergroup'], summary: '批量删除' } },
