...
const routerBaseInfo = {
  modelName_U: 'OtherTarget',
  modelName_L: 'othertarget',
  getURL: '/api/othertarget/:id',
  getAllURL: '/api/othertargets',
  getListURL: '/api/getOtherTargetList',
  putURL: '/api/othertarget',
  deleteURL: '/api/othertargets',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['othertarget'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['othertarget'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['othertarget'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['othertarget'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['othertarget'], summary: '批量删除' } },
      remove,
  );
