...
module.exports = fp(async (server, opts, next) => {
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['currentModelName'], summary: '根据ID获取单个' } },
      async (request, reply) => {
        const runFun = async () => {
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['currentModelName'], summary: '根据条件获取列表' } },
      async (request, reply) => {
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['currentModelName'], summary: '批量删除' } },
      async (request, reply) => {
