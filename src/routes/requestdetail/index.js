 ...
 * @LastEditTime: 2021-03-18 15:22:25
 * @LastEditors: zpl
 */
...
const routerBaseInfo = {
  ...
  getURL: '/api/requestdetail/:id',
  getAllURL: '/api/requestdetails',
  getListURL: '/api/getRequestDetailList',
  saveOnRequestURL: '/api/requestdetail/saveOnRequest',
  deleteURL: '/api/requestdetails',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['requestdetail'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['requestdetail'], summary: '获取所有' } },
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['requestdetail'], summary: '根据条件获取列表' } },
  ...
  server.put(routerBaseInfo.saveOnRequestURL,
      { schema: { ...saveOnRequestSchema, tags: ['requestdetail'], summary: '保存到申请中' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['requestdetail'], summary: '批量删除' } },
