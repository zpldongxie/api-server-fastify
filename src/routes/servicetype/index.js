...
const routerBaseInfo = {
  modelName_U: 'ServiceType',
  modelName_L: 'servicetype',
  getURL: '/api/servicetype/:id',
  getAllURL: '/api/servicetypes',
  getListURL: '/api/getServiceTypeList',
  putURL: '/api/servicetype',
  deleteURL: '/api/servicetypes',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['servicetype'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['servicetype'], summary: '获取所有' } },
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['servicetype'], summary: '根据条件获取列表' } },
      (request, reply) => method.queryList(request, reply),
  );

  const updateSchema = require('./update-schema');
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['servicetype'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['servicetype'], summary: '批量删除' } },
