...
const routerBaseInfo = {
  modelName_U: 'SupportingDoc',
  modelName_L: 'supportingdoc',
  getURL: '/api/supportingdoc/:id',
  getAllURL: '/api/supportingdocs',
  getListURL: '/api/getSupportingDocList',
  putURL: '/api/supportingdoc',
  deleteURL: '/api/supportingdocs',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['supportingdoc'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['supportingdoc'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['supportingdoc'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['supportingdoc'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['supportingdoc'], summary: '批量删除' } },
      remove,
  );
