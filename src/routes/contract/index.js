...
const routerBaseInfo = {
  modelName_U: 'Contract',
  modelName_L: 'contract',
...
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['contract'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['contract'], summary: '获取所有' } },
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['contract'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['contract'], summary: '批量删除' } },
