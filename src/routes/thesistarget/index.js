...
const routerBaseInfo = {
  modelName_U: 'ThesisTarget',
  modelName_L: 'thesistarget',
  getURL: '/api/thesistarget/:id',
  getAllURL: '/api/thesistargets',
  getListURL: '/api/getThesisTargetList',
  putURL: '/api/thesistarget',
  deleteURL: '/api/thesistargets',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['thesistarget'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['thesistarget'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['thesistarget'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['thesistarget'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['thesistarget'], summary: '批量删除' } },
      remove,
  );
