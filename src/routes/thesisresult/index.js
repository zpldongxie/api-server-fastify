...
const routerBaseInfo = {
  modelName_U: 'ThesisResult',
  modelName_L: 'thesisresult',
  getURL: '/api/thesisresult/:id',
  getAllURL: '/api/thesisresults',
  getListURL: '/api/getThesisResultList',
  putURL: '/api/thesisresult',
  deleteURL: '/api/thesisresults',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['thesisresult'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['thesisresult'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['thesisresult'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['thesisresult'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['thesisresult'], summary: '批量删除' } },
      remove,
  );
