...
const routerBaseInfo = {
  modelName_U: 'Evaluation',
  modelName_L: 'evaluation',
  getURL: '/api/evaluation/:id',
  getAllURL: '/api/evaluations',
  getListURL: '/api/getEvaluationList',
  putURL: '/api/evaluation',
  deleteURL: '/api/evaluations',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['evaluation'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['evaluation'], summary: '获取所有' } },
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['evaluation'], summary: '根据条件获取列表' } },
      (request, reply) => method.queryList(request, reply),
  );

  const updateSchema = require('./update-schema');
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['evaluation'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['evaluation'], summary: '批量删除' } },
