...
const routerBaseInfo = {
  modelName_U: 'TmtResult',
  modelName_L: 'tmtresult',
  getURL: '/api/tmtresult/:id',
  getAllURL: '/api/tmtresults',
  getListURL: '/api/getTmtResultList',
  putURL: '/api/tmtresult',
  deleteURL: '/api/tmtresults',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['tmtresult'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['tmtresult'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['tmtresult'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['tmtresult'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['tmtresult'], summary: '批量删除' } },
      remove,
  );
