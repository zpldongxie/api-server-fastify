...
const routerBaseInfo = {
  modelName_U: 'ProjectResult',
  modelName_L: 'projectresult',
  getURL: '/api/projectresult/:id',
  getAllURL: '/api/projectresults',
  getListURL: '/api/getProjectResultList',
  putURL: '/api/projectresult',
  deleteURL: '/api/projectresults',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      { schema: { ...getByIdSchema, tags: ['projectresult'], summary: '根据ID获取单个' } },
      getById,
  );
  ...
  server.get(
      ...
      { schema: { tags: ['projectresult'], summary: '获取所有' } },
      getAll,
  );
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['projectresult'], summary: '根据条件获取列表' } },
      queryList,
  );
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['projectresult'], summary: '新增或更新' } },
      upsert,
  );
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['projectresult'], summary: '批量删除' } },
      remove,
  );
