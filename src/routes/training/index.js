 ...
 * @LastEditTime: 2021-01-19 17:33:17
 * @LastEditors: zpl
 */
...
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['training'], summary: '根据ID获取单个' },
        config: { ChannelModel },
      },
  ...
  server.get(
      ...
      {
        schema: { tags: ['training'], summary: '获取所有' },
        config: { ChannelModel },
      },
  ...
  server.post(
      ...
      {
        schema: { ...queryListSchema, tags: ['training'], summary: '根据条件获取列表' },
        config: { ChannelModel },
      },
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['training'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['training'], summary: '批量删除' } },
