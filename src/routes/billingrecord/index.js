...
const routerBaseInfo = {
  modelName_U: 'BillingRecord',
  modelName_L: 'billingrecord',
  getURL: '/api/billingrecord/:id',
  getAllURL: '/api/billingrecords',
  getListURL: '/api/getBillingRecordList',
  putURL: '/api/billingrecord',
  deleteURL: '/api/billingrecords',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['billingrecord'], summary: '根据ID获取单个' },
      },
      async (request, reply) => {
  ...
  server.get(
      ...
      { schema: { tags: ['billingrecord'], summary: '获取所有' } },
      async (request, reply) => {
        await method.run(request, reply)(
            async () => {
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['billingrecord'], summary: '根据条件获取列表' } },
      (request, reply) => method.queryList(request, reply),
  );

  const updateSchema = require('./update-schema');
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['billingrecord'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['billingrecord'], summary: '批量删除' } },
