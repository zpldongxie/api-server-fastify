...
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['modular'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['modular'], summary: '获取所有' } },
  ...
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['modular'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['modular'], summary: '批量删除' } },
