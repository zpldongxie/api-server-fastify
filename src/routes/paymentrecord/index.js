...
const routerBaseInfo = {
  modelName_U: 'PaymentRecord',
  modelName_L: 'paymentrecord',
  getURL: '/api/paymentrecord/:id',
  getAllURL: '/api/paymentrecords',
  getListURL: '/api/getPaymentRecordList',
  putURL: '/api/paymentrecord',
  deleteURL: '/api/paymentrecords',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['paymentrecord'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['paymentrecord'], summary: '获取所有' } },
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['paymentrecord'], summary: '根据条件获取列表' } },
      (request, reply) => method.queryList(request, reply),
  );

  const updateSchema = require('./update-schema');
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['paymentrecord'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['paymentrecord'], summary: '批量删除' } },
