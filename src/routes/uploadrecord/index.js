...
const routerBaseInfo = {
  ...
  getURL: '/api/uploadrecord/:id',
  getAllURL: '/api/uploadrecords',
  getListURL: '/api/getUploadRecordList',
  putURL: '/api/uploadrecord',
  deleteURL: '/api/uploadrecords',
};
module.exports = fp(async (server, opts, next) => {
  ...
  */
  ...
  server.get(
      ...
      {
        schema: { ...getByIdSchema, tags: ['uploadrecord'], summary: '根据ID获取单个' },
      },
  ...
  server.get(
      ...
      { schema: { tags: ['uploadrecord'], summary: '获取所有' } },
  ...
  server.post(
      ...
      { schema: { ...queryListSchema, tags: ['uploadrecord'], summary: '根据条件获取列表' } },
      (request, reply) => method.queryList(request, reply),
  );

  const updateSchema = require('./update-schema');
  server.put(routerBaseInfo.putURL,
      { schema: { ...updateSchema, tags: ['uploadrecord'], summary: '新增或更新' } },
  ...
  server.delete(
      ...
      { schema: { ...deleteSchema, tags: ['uploadrecord'], summary: '批量删除' } },
