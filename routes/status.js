...
// Exporting a constant named `autoPrefix` will tell to `fastify-autoload` that this plugin must be loaded with the prefix option.
// In this way every route declared inside this plugin and its children will have the prefix as part of the path.
...
export default async function status (fastify, opts) {
  ...
  fastify.route({
    ...
    schema: {
      // 为支持openAPI，必须声明tags和operationId，其中operationId的命名规范采用method+path
      tags: ['other'],
